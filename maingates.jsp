          ...
          file4 = new File("g4.jpg");
	           %>
	        	...
	        	<div class="featured portfolio-list">
	        		<figure>
	        			<a href="img/gates/g11.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g11.jpg" alt="Alt text" /></a>
	        			<div>
	        		...
	        		<figure>
	        			<a href="img/gates/g22.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g22.jpg" alt="Alt text" /></a>
	        			<div>
	        			<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g33.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g33.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g44.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g44.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g55.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g55.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g66.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g66.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g77.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g77.jpg" alt="Alt text" /></a>
	        			<div>
	        			<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g88.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g88.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
	        		...
	        		<figure>
	        			<a href="img/gates/g99.jpg" data-rel="prettyPhoto" class="thumb"><img src="img/gates/g99.jpg" alt="Alt text" /></a>
	        			<div>
	        				<a href="card.jsp?innerVolume=<%=file%>"><font color=orange><li>BUY</li></a>
		        		</div>
		        		<a class="link" href="project.html"></a>
        		...
        		<ul class="pager">
					...
					<li><a href="maingates2.jsp">2</a></li>
